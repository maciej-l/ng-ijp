...
@Component({
  selector: 'grosz-ijp',
  templateUrl: './grosz.component.html',
  styleUrls: ['./grosz.component.scss'],
  providers: [
    IjpConnectionService,
    StatusService
  ]
})
export class GroszComponent implements OnInit {
  data: any;
  lookoData = new IjpData(null, null, null, null);
  pm10Bcg: string;
  pm25Bcg: string;
  ijpBcg: string;
  locationName = 'Opole - Groszowice';
