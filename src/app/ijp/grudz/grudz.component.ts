...
@Component({
  selector: 'grudz-ijp',
  templateUrl: './grudz.component.html',
  styleUrls: ['./grudz.component.scss'],
  providers: [
    IjpConnectionService,
    StatusService
  ]
})
export class GrudzComponent implements OnInit {
  data: any;
  lookoData = new IjpData(null, null, null, null);
  pm10Bcg: string;
  pm25Bcg: string;
  ijpBcg: string;
  locationName = 'Grudzice';
  constructor(
